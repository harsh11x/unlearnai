  ...
  return (
    <div className="soft-card p-6 md:p-10 bg-white space-y-8 font-sans">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-slate-200 pb-6">
        <div>
          <div className="soft-badge mb-2">FINANCIAL & COMPUTE CALCULATOR</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-6 space-y-6 font-sans">
          ...
          <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
            <div className="flex justify-between items-center text-xs font-semibold text-slate-700">
              ...
              <span className="text-xs font-bold text-indigo-600 bg-white border border-slate-200 px-3 py-1 rounded-lg shadow-sm">
        ...
        <div className="lg:col-span-6 rounded-2xl p-6 bg-slate-950 text-white space-y-6 border border-slate-800 shadow-2xl">
          ...
          <div>
            <div className="font-sans text-xs text-slate-400 font-semibold uppercase">TOTAL ANNUAL COST SAVINGS</div>
          ...
          <div className="font-sans text-xs text-slate-300 bg-slate-900/80 p-3.5 rounded-xl border border-slate-800 flex items-center justify-between">
            <span className="flex items-center gap-2 text-emerald-400 font-semibold">
              <CheckCircle2 size={16} /> Instant GDPR & CCPA Compliance
            </span>
