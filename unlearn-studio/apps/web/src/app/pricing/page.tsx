...
const TIERS = [
  {
    ...
    price: "$0",
    period: "forever",
    description: "Try Unlearn Studio with a single small model.",
    cta: "Start Free",
    ctaHref: "/#cta",
    highlight: false,
    features: [
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 border border-border p-10 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-6">
              <a href="mailto:enterprise@unlearnstudio.ai" className="btn-primary no-underline">
          ...
          <div className="mt-20 max-w-3xl mx-auto">
            ...
            {[
              ...
              },
              {
                ...
                a: "Yes. All processing happens locally on your machine (desktop app) or on your infrastructure (API). We never see your model weights or training data.",
              },
            ].map((faq, i) => (
