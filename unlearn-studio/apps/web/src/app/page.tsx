          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center pt-6">
            ...
            <div className="space-y-6 w-full">
              {[
                ...
                <div 
                  key={idx} 
                  className={`sticky-note ${item.color} p-5 md:p-6 flex items-start gap-4 transition-all hover:translate-x-2 w-full`}
                >
      ...
      <div className="w-full px-3 sm:px-6 md:px-10 lg:px-14 mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((f, i) => (
            <div
              key={f.title}
              className={`sticky-note ${f.color} p-7 md:p-8 flex flex-col justify-between w-full`}
            >
              <div>
    ...
    <section className="py-36 md:py-48 lg:py-60 bg-[#fef08a] border-b-4 border-[#0f172a] chart-grid">
      <div className="w-full px-3 sm:px-6 md:px-10 lg:px-14 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="bg-white border-3 border-[#0f172a] shadow-[8px_8px_0_0_#0f172a] p-5 md:p-6 rotate-1 w-full">
            <div className="font-mono text-xs md:text-sm font-black uppercase bg-[#0f172a] text-white p-3.5 flex justify-between items-center mb-3">
    ...
    <section id="research" className="py-36 md:py-48 lg:py-60 bg-[#eae5d9] border-b-4 border-[#0f172a]">
      <div className="w-full px-3 sm:px-6 md:px-10 lg:px-14 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 w-full">
          ...
          {/* Memo 1: What We Do */}
          <div className="sticky-note bg-[#bbf7d0] p-7 md:p-8 -rotate-1 w-full">
            <div className="tape tape-top-left"></div>
          ...
          <div className="sticky-note bg-[#fbcfe8] p-7 md:p-8 rotate-1 w-full">
            <div className="tape tape-top-right"></div>
            <h3 className="font-mono text-lg md:text-xl font-black text-[#0f172a] uppercase border-b-2 border-[#0f172a] pb-3 mb-5 flex items-center gap-2">
