...
import {
  ...
  Layers, Zap, Code, Lock, RefreshCw, FileCheck, Terminal
} from "lucide-react";

/* ════════════ COMIC CUT DIVIDER COMPONENT ════════════ */
function ComicDivider({ fill = "#eae5d9" }: { fill?: string }) {
  return (
    <div className="w-full overflow-hidden leading-none z-20 relative -mb-1 -mt-1 pointer-events-none">
      <svg
        ...
        fill={fill}
      >
        <path d="M0,48 L40,6 L80,38 L130,2 L180,42 L240,8 L300,44 L360,4 L420,40 L490,10 L560,46 L620,6 L680,42 L750,4 L820,44 L890,8 L960,40 L1030,2 L1110,42 L1200,0 L1200,48 Z" />
      </svg>
    </div>
  );
}
...
function Hero() {
  return (
    <section className="relative min-h-[95vh] flex flex-col justify-center pt-44 sm:pt-56 md:pt-64 lg:pt-72 pb-32 sm:pb-40 md:pb-48 bg-[#eae5d9] chart-grid overflow-hidden">
      {/* Floating Sticky Decorative Badges */}
      <div className="absolute top-40 right-14 w-40 h-40 bg-[#fef08a] border-2 border-[#0f172a] rotate-12 opacity-40 pointer-events-none hidden xl:block shadow-[4px_4px_0_0_#0f172a]">
        <div className="p-3 font-hand text-xl text-slate-800">unlearn_codegen.py</div>
        <div className="font-mono text-[10px] text-slate-600 mt-2">loss = L_forget + λ L_retain</div>
      </div>
      <div className="absolute bottom-20 left-10 w-36 h-36 bg-[#fbcfe8] border-2 border-[#0f172a] -rotate-12 opacity-40 pointer-events-none hidden xl:block shadow-[4px_4px_0_0_#0f172a]">
        <div className="p-3 font-hand text-lg text-slate-800">python_target = 0%</div>
        <div className="font-mono text-[10px] text-slate-600 mt-2">retain_js = 50.0%</div>
      </div>
      ...
      <div className="w-full px-4 sm:px-8 md:px-12 lg:px-16 mx-auto relative z-10 my-auto">
        ...
        <div className="inline-flex items-center gap-2 bg-[#ffffff] border-2 border-[#0f172a] px-4 py-2 shadow-[3px_3px_0_0_#0f172a] mb-10 -rotate-1">
          ...
          <span className="font-mono text-xs md:text-sm font-bold uppercase tracking-widest text-[#0f172a]">
            📌 NULLMIND V1.0 — OPEN-SOURCE MACHINE UNLEARNING STUDIO
          </span>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-16 items-start">
          
          {/* Left Column: Headline & Comprehensive Project Overview */}
          <div className="w-full">
            ...
            {/* Rich Informative Subtitle Card */}
            <div className="mt-8 relative bg-white border-2 border-[#0f172a] p-6 md:p-8 shadow-[6px_6px_0_0_#0f172a] rotate-1 w-full">
              ...
              <div className="flex items-center gap-2 mb-3">
                <span className="font-mono text-xs font-black uppercase bg-[#0f172a] text-white px-2 py-0.5">WHAT THIS PROJECT DOES</span>
                <span className="font-hand text-lg text-slate-600">~ Target Erasure Architecture ~</span>
              </div>

              <p className="font-mono text-xs md:text-sm lg:text-base font-bold text-slate-800 leading-relaxed">
                NullMind is an open-source PyTorch platform that performs{" "}
                <span className="bg-[#bae6fd] px-1.5 py-0.5 border border-[#0f172a]">
                  measured capability reduction
                </span>{" "}
                in LLMs. Instead of retraining models from scratch ($100k+), we execute targeted gradient ascent to erase specified domains (e.g. Python code generation, copyrighted content, PII) while preserving all other capabilities.
              </p>

              {/* Informative Bullet Tags */}
              <div className="mt-6 pt-4 border-t-2 border-dashed border-[#0f172a]/20 grid grid-cols-1 sm:grid-cols-2 gap-3 font-mono text-xs font-bold">
                <div className="flex items-center gap-2 bg-[#fef08a] p-2 border border-[#0f172a]">
                  <Lock size={14} className="text-[#0f172a]" /> GDPR Right to Erasure
                </div>
                <div className="flex items-center gap-2 bg-[#bbf7d0] p-2 border border-[#0f172a]">
                  <RefreshCw size={14} className="text-[#0f172a]" /> Zero Retraining Cost
                </div>
                <div className="flex items-center gap-2 bg-[#fbcfe8] p-2 border border-[#0f172a]">
                  <Shield size={14} className="text-[#0f172a]" /> Copyright & PII Removal
                </div>
                <div className="flex items-center gap-2 bg-[#bae6fd] p-2 border border-[#0f172a]">
                  <FileCheck size={14} className="text-[#0f172a]" /> 89 Probes Verification
                </div>
              </div>
            </div>
          ...
          {/* Right Column: Informative Live Terminal Memo + Stats Sticky Notes */}
          <div className="space-y-6 w-full">
            
            {/* Live Terminal Sticky Memo */}
            <div className="bg-[#0f172a] text-white p-5 border-2 border-[#0f172a] shadow-[6px_6px_0_0_#0f172a] -rotate-1 relative">
              <div className="tape tape-top-center"></div>
              <div className="flex items-center justify-between border-b border-white/20 pb-2 mb-3 font-mono text-xs">
                <div className="flex items-center gap-2 text-[#fef08a]">
                  <Terminal size={14} /> nullmind_eval_logger.sh
                </div>
                <span className="text-white/40">v1.0.4</span>
              </div>
              <div className="font-mono text-xs space-y-1.5 text-slate-300">
                <p className="text-green-400">$ nullmind run --model salesforce/codegen-350M --target python</p>
                <p>[+] Baseline Evaluation: Python 50.0%, JS 50.0%, C++ 75.0%</p>
                <p>[+] Running Gradient Ascent on Target (Epoch 3/3)...</p>
                <p>[+] Running Gradient Descent on Retain Set (λ = 1.2)...</p>
                <p className="text-[#fef08a] font-bold">[✓] EVAL RESULT: Python 0.0% | Retain Preserved | VERDICT: PASS</p>
              </div>
            </div>

            {/* Interactive Sticky Note Grid Stats */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
              
              {/* Sticky 1 */}
              <div className="sticky-note bg-[#fef08a] p-5 -rotate-2 w-full">
                <div className="tape tape-top-center"></div>
                <div className="font-mono text-3xl md:text-4xl font-black text-[#0f172a]">20+</div>
                <div className="font-mono text-xs font-bold uppercase tracking-wider text-slate-700 mt-2 border-t-2 border-[#0f172a]/30 pt-2">
                  Probe Categories
                </div>
                <div className="font-hand text-lg text-slate-700 mt-1">Code, Safety, Math...</div>
              </div>

              {/* Sticky 2 */}
              <div className="sticky-note bg-[#bae6fd] p-5 rotate-2 w-full">
                <div className="tape tape-top-right"></div>
                <div className="font-mono text-3xl md:text-4xl font-black text-[#0f172a]">89</div>
                <div className="font-mono text-xs font-bold uppercase tracking-wider text-slate-700 mt-2 border-t-2 border-[#0f172a]/30 pt-2">
                  Evaluation Probes
                </div>
                <div className="font-hand text-lg text-slate-700 mt-1">Targeted test battery</div>
              </div>

              {/* Sticky 3 */}
              <div className="sticky-note bg-[#fbcfe8] p-5 rotate-2 w-full">
                <div className="tape tape-top-left"></div>
                <div className="font-mono text-3xl md:text-4xl font-black text-[#0f172a]">2</div>
                <div className="font-mono text-xs font-bold uppercase tracking-wider text-slate-700 mt-2 border-t-2 border-[#0f172a]/30 pt-2">
                  Unlearn Methods
                </div>
                <div className="font-hand text-lg text-slate-700 mt-1">Ascent + Retain Loss</div>
              </div>

              {/* Sticky 4 */}
              <div className="sticky-note bg-[#bbf7d0] p-5 -rotate-2 w-full">
                <div className="tape tape-top-center"></div>
                <div className="font-mono text-3xl md:text-4xl font-black text-[#0f172a]">5</div>
                <div className="font-mono text-xs md:text-sm font-bold uppercase tracking-wider text-slate-700 mt-2 border-t-2 border-[#0f172a]/30 pt-2">
                  Languages Tested
                </div>
                <div className="font-hand text-lg text-slate-700 mt-1">Python, JS, TS, C++</div>
              </div>
...
function ProblemSection() {
  return (
    <>
      <ComicDivider fill="#e5dec9" />
      <section className="relative min-h-[75vh] flex flex-col justify-center py-16 sm:py-20 md:py-24 bg-[#e5dec9]">
        <div className="w-full px-4 sm:px-8 md:px-12 lg:px-16 mx-auto my-auto">
          ...
          <div className="cardboard p-6 sm:p-10 md:p-14 relative w-full">
            {/* Header Badge */}
            <div className="inline-block bg-[#ef4444] text-white px-4 py-1.5 font-mono font-black text-xs uppercase tracking-widest border-2 border-[#0f172a] shadow-[2px_2px_0_0_#0f172a] mb-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              {/* Left Box */}
              <div className="w-full">
                <div className="stamp mb-5">CONFIDENTIAL</div>
                ...
                <p className="mt-5 font-mono text-sm md:text-base text-slate-800 leading-relaxed">
...
function HowItWorks() {
  ...
  return (
    <>
      <ComicDivider fill="#eae5d9" />
      <section id="how-it-works" className="relative min-h-[75vh] flex flex-col justify-center py-16 sm:py-20 md:py-24 bg-[#eae5d9]">
        <div className="w-full px-4 sm:px-8 md:px-12 lg:px-16 mx-auto my-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
            {steps.map((step) => (
              <div
                key={step.num}
                className={`sticky-note ${step.color} ${step.rot} p-6 md:p-8 flex flex-col justify-between min-h-[270px] w-full`}
              >
                <div className="tape tape-top-center"></div>
...
function VisualPipeline() {
  return (
    <>
      <ComicDivider fill="#f4efe4" />
      <section className="relative min-h-[75vh] flex flex-col justify-center py-16 sm:py-20 md:py-24 bg-[#f4efe4]">
        <div className="w-full px-4 sm:px-8 md:px-12 lg:px-16 mx-auto my-auto">
          ...
          <div className="bg-white border-3 border-[#0f172a] p-6 md:p-10 lg:p-12 shadow-[10px_10px_0_0_#0f172a] chart-grid-dense relative w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10">
              ...
              {/* Phase 1 */}
              <div className="bg-[#fef08a] border-2 border-[#0f172a] p-6 md:p-8 shadow-[5px_5px_0_0_#0f172a] relative -rotate-1 w-full">
              ...
              {/* Phase 2 */}
              <div className="bg-[#fbcfe8] border-2 border-[#0f172a] p-6 md:p-8 shadow-[5px_5px_0_0_#0f172a] relative rotate-1 w-full">
                <div className="absolute top-2 right-2 font-mono text-xs font-bold bg-[#0f172a] text-white px-2 py-0.5">
                  PHASE B
                </div>
                <h3 className="font-mono text-lg md:text-xl font-black text-[#0f172a] uppercase border-b-2 border-[#0f172a] pb-2 mb-4">
              ...
              {/* Phase 3 */}
              <div className="bg-[#bbf7d0] border-2 border-[#0f172a] p-6 md:p-8 shadow-[5px_5px_0_0_#0f172a] relative -rotate-1 w-full">
                <div className="absolute top-2 right-2 font-mono text-xs font-bold bg-[#0f172a] text-white px-2 py-0.5">
                  PHASE C
                </div>
                <h3 className="font-mono text-lg md:text-xl font-black text-[#0f172a] uppercase border-b-2 border-[#0f172a] pb-2 mb-4">
...
function Features() {
  ...
  return (
    <>
      <ComicDivider fill="#e5dec9" />
      <section id="features" className="relative min-h-[75vh] flex flex-col justify-center py-16 sm:py-20 md:py-24 bg-[#e5dec9]">
        <div className="w-full px-4 sm:px-8 md:px-12 lg:px-16 mx-auto my-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
            {features.map((f, i) => (
              <div
                key={f.title}
                className={`sticky-note ${f.color} p-6 md:p-8 flex flex-col justify-between w-full`}
              >
                <div>
                  <div className="w-12 h-12 bg-[#0f172a] text-white flex items-center justify-center mb-4 border border-[#0f172a]">
                    <f.icon size={22} />
                  </div>
                  <h3 className="font-mono text-lg font-black text-[#0f172a] uppercase">{f.title}</h3>
                  <p className="font-mono text-xs md:text-sm font-bold text-slate-800 leading-relaxed mt-2">{f.desc}</p>
                </div>
                <div className="font-hand text-xl text-slate-600 mt-5 text-right">
                  #feature-{i + 1}
                </div>
              </div>
            ))}
...
function Results() {
  ...
  return (
    <>
      <ComicDivider fill="#fef08a" />
      <section className="relative min-h-[75vh] flex flex-col justify-center py-16 sm:py-20 md:py-24 bg-[#fef08a] chart-grid">
        <div className="w-full px-4 sm:px-8 md:px-12 lg:px-16 mx-auto my-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="w-full">
              ...
              <div className="mt-6 p-6 md:p-8 bg-white border-2 border-[#0f172a] shadow-[6px_6px_0_0_#0f172a] -rotate-1 w-full">
...
function ResearchSection() {
  return (
    <>
      <ComicDivider fill="#eae5d9" />
      <section id="research" className="relative min-h-[75vh] flex flex-col justify-center py-16 sm:py-20 md:py-24 bg-[#eae5d9]">
        <div className="w-full px-4 sm:px-8 md:px-12 lg:px-16 mx-auto my-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 w-full">
            ...
            {/* Memo 1: What We Do */}
            <div className="sticky-note bg-[#bbf7d0] p-7 md:p-9 -rotate-1 w-full">
              <div className="tape tape-top-left"></div>
              <h3 className="font-mono text-lg md:text-xl font-black text-[#0f172a] uppercase border-b-2 border-[#0f172a] pb-3 mb-4 flex items-center gap-2">
            ...
            <div className="sticky-note bg-[#fbcfe8] p-7 md:p-9 rotate-1 w-full">
              <div className="tape tape-top-right"></div>
              <h3 className="font-mono text-lg md:text-xl font-black text-[#0f172a] uppercase border-b-2 border-[#0f172a] pb-3 mb-4 flex items-center gap-2">
...
function CTASection() {
  return (
    <>
      <ComicDivider fill="#f4efe4" />
      <section className="relative min-h-[65vh] flex flex-col justify-center py-16 sm:py-20 md:py-24 bg-[#f4efe4]">
...
function Footer() {
  return (
    <footer className="py-14 bg-[#0f172a] text-white">
