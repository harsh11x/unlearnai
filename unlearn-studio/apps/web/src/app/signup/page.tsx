      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="soft-card p-8 bg-white space-y-6 shadow-xl shadow-slate-200/50">
          <div className="space-y-2">
            ...
            <h1 className="text-2xl font-extrabold text-slate-900">Create NullMind Account</h1>
            <p className="text-xs text-slate-500">Start measured LLM unlearning with 89 empirical probes.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 font-sans text-xs">
            ...
            <button type="submit" className="soft-btn-primary w-full py-3.5 text-xs mt-2">
              <Sparkles size={14} /> {loading ? "Creating Account..." : "Create Free Account →"}
            </button>
          </form>

          <div className="relative border-t border-slate-200 text-center">
            <span className="bg-white px-3 text-[11px] font-semibold text-slate-400 relative -top-2.5">OR REGISTER WITH</span>
          </div>
